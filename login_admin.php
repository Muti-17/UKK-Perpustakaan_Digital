...
if(isset($_POST['kirim'])){ 
    ...
    if (password_verify($password, $user['password'])) {
        ...
        header('location:login_admin.php?s=password_salah');
    }

    } else {
        header('location:login_admin.php?s=username_notfound');
    }
...
>
  <head>
    ...
    <title>Login Admin - Perpustakaan Digital SMKN 1 Lemahsugih</title>
            ...
            <div class="card-body">
              ...
              <?php
                if(isset($_GET['s'])){
                  ...
                  else if($_GET['s'] == "username_notfound"){
                    ?>
                    <div class="alert alert-danger" role="alert">
